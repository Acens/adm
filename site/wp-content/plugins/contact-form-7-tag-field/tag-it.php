...
function contact_form_7_tagit_fields() {
	...
	if(function_exists('wpcf7_add_shortcode')) {
		wpcf7_add_shortcode( 'tagit', 'wpcf7_tagit_shortcode_handler', true );
		wpcf7_add_shortcode( 'tagit*', 'wpcf7_tagit_shortcode_handler', true );
	} else {
...
function tagit_add_stylesheets() {
	...
	wp_register_style( 'tag-it-ui', plugins_url( 'jquery.tagit.css' , __FILE__ ) );
	wp_enqueue_style( 'tag-it-ui' );
	wp_register_style( 'tag-it-ui-zendesk', plugins_url( 'tagit.ui-zendesk.css' , __FILE__ ) );
	wp_enqueue_style( 'tag-it-ui-zendesk' );
